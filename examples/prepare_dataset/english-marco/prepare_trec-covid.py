...
def main(input_dir, output_dir):
    corpus, queries, qrels = GenericDataLoader(data_folder=input_dir).load(split="test")
    concat_corpus = {key: concat_title_body(value) for key, value in corpus.items()}
...
if __name__ == "__main__":
    main("./data/datasets/trec-covid", "./data/datasets/trec-covid")
