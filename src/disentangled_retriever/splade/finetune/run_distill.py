...
from .distill_utils import (
    ...
    BackboneDistillSpladeFinetuner,
    AdapterDistillSpladeFinetuner
)
...
class DenseFinetuneArguments(TrainingArguments):
    ...
    q_flops_loss_factor: float = field(default=0.1)
    p_flops_loss_factor: float = field(default=0.1)
...
def main():
    ...
    if model_args.new_adapter_name is None:
        ...
        trainer_class = BackboneDistillSpladeFinetuner
    else:
        trainer_class = AdapterDistillSpladeFinetuner
